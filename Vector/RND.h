...
//void dissertation(const int it = 1, const int a = 10, const int n = 5, const int m = 10000);
//void ReverseTest(const int it = 1, const int a = 10, const int n = 5, const int m = 10000);
void DeltaTest(const int it = 1, const int a = 5, const int n = 5, const int m = 100000);